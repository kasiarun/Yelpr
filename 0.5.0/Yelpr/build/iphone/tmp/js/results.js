$(function() {
  try {
    //Insert API Key Here
    var api_key = "6SVw8vw3j9cTgdj4P56mJQ";
    ...
    //Make request
    var tkn = Titanium.Geolocation.getCurrentPosition(function(pos) {
      Titanium.Geolocation.clearWatch(tkn);
      var latitude = pos.coords.latitude;
      var longitude = pos.coords.longitude;
      var query = "http://api.yelp.com/business_review_search?term="+term+"&category="+category+"&lat="+latitude+"&long="+longitude+"&num_biz_requested=20&ywsid="+api_key;
